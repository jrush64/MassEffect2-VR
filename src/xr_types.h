...
// XR_FB_display_refresh_rate (optional): lets AER pace cleanly to the real headset Hz. Resolved only if advertised.
...
struct Functions
{
    ...
    PFN_xrGetDisplayRefreshRateFB getDisplayRefreshRate = nullptr;   // optional (XR_FB_display_refresh_rate)
};
